...
const App = () => (
  <PageWrapper>
    <div className="main_content">
      <Card title="Стиральная машина Bosch" img={machine} alt="Стиральная машина" section="Техника" description="Машина в хорошем состоянии. Возможен разумный торг" price="22 500 Р" date="14 апреля 2021" icon={eye} views="356" />
      <Card title="Шапочка" img={hat} alt="шапочка" section="Одежда" description="Шапочка детская на ребенка 7-10 лет. 60% шерсть, 40% вискоза" price="500 Р " date="14 апреля 2021" icon={eye} views="356" />
      <Card title="Толстовка" img={hoody} alt="толстовка" section="Одежда" description="Новая толстовка белая без принта с карманом" price="2000 Р " date="14 апреля 2021" icon={eye} views="356" />
      <Card
        title="Велосипед"
        img={bicycle}
